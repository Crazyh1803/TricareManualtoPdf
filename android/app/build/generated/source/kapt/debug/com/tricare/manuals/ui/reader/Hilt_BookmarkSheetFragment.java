...
public abstract class Hilt_BookmarkSheetFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookmarkSheetFragment() {
    super();
  }

  Hilt_BookmarkSheetFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookmarkSheetFragment_GeneratedInjector) this.generatedComponent()).injectBookmarkSheetFragment(UnsafeCasts.<BookmarkSheetFragment>unsafeCast(this));
    }
  }
