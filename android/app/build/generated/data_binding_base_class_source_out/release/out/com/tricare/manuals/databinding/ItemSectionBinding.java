...
public final class ItemSectionBinding implements ViewBinding {
  ...
  private ItemSectionBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvSectionContent,
      @NonNull TextView tvSectionTitle) {
    this.rootView = rootView;
    this.tvSectionContent = tvSectionContent;
  ...
  public static ItemSectionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tv_section_content;
      TextView tvSectionContent = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemSectionBinding((MaterialCardView) rootView, tvSectionContent, tvSectionTitle);
    }
