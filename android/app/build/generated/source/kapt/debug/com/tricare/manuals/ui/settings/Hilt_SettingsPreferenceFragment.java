...
public abstract class Hilt_SettingsPreferenceFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingsPreferenceFragment_GeneratedInjector) this.generatedComponent()).injectSettingsPreferenceFragment(UnsafeCasts.<SettingsPreferenceFragment>unsafeCast(this));
    }
  }
