...
public abstract class Hilt_DownloadDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DownloadDialogFragment() {
    super();
  }

  Hilt_DownloadDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DownloadDialogFragment_GeneratedInjector) this.generatedComponent()).injectDownloadDialogFragment(UnsafeCasts.<DownloadDialogFragment>unsafeCast(this));
    }
  }
