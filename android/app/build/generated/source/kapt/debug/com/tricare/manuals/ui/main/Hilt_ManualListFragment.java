...
public abstract class Hilt_ManualListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ManualListFragment() {
    super();
  }

  Hilt_ManualListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManualListFragment_GeneratedInjector) this.generatedComponent()).injectManualListFragment(UnsafeCasts.<ManualListFragment>unsafeCast(this));
    }
  }
